...
const (
	...
	// SetCrName specifies the name of the custome resource of the meta operator set
	...
	// ConfigCrName specifies the name of the custome resource of the meta operator config
