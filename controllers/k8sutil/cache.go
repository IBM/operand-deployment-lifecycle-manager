...
func NewODLMCache(isolatedModeEnable bool, opts ctrl.Options) ctrl.Options {
	...
	// this will make sure that the cache will return an error when the informer is not found
	// cacheReaderFailOnMissingInformer := true
...
// 			ByObject:                    cacheByObject,
// 			DefaultNamespaces:           cacheDefaultNamespaces,
// 			ReaderFailOnMissingInformer: cacheReaderFailOnMissingInformer,
// 			SyncPeriod:                  &syncPeriod,
// 			Scheme:                      opts.Scheme,
// 		}
...
// 		listerWatcher := toolscache.NewFilteredListWatchFromClient(client, plural, util.GetOperatorNamespace(), func(options *metav1.ListOptions) {})
...
// func (c ODLMCache) Get(ctx context.Context, key client.ObjectKey, obj client.Object, getOption ...client.GetOption) error {
...
// func (c ODLMCache) GetInformer(ctx context.Context, obj client.Object, getInformerOption ...cache.InformerGetOption) (cache.Informer, error) {
// 	gvk, err := apiutil.GVKForObject(obj, c.Scheme)
// 	if err != nil {
// 		return nil, err
// 	}
...
// func (c ODLMCache) GetInformerForKind(ctx context.Context, gvk schema.GroupVersionKind, getInformerOption ...cache.InformerGetOption) (cache.Informer, error) {
// 	if informer, ok := c.informerMap[gvk]; ok {
// 		return informer, nil
// 	}
// 	// Passthrough
