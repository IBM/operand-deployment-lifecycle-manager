...
var log = logf.Log.WithName("controller_operandbindinfo")
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileOperandBindInfo{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func (r *ReconcileOperandBindInfo) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling OperandBindInfo")

	// Fetch the OperandBindInfo instance
	instance := &operatorv1alpha1.OperandBindInfo{}
