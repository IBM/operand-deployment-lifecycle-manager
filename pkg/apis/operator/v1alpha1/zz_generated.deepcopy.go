...
func (in *OperandRequestSpec) DeepCopyInto(out *OperandRequestSpec) {
	*out = *in
	if in.Services != nil {
		in, out := &in.Services, &out.Services
		*out = make([]RequestService, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RequestService) DeepCopyInto(out *RequestService) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RequestService.
func (in *RequestService) DeepCopy() *RequestService {
	if in == nil {
		return nil
	}
	out := new(RequestService)
	in.DeepCopyInto(out)
	return out
}
